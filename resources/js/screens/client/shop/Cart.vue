        ...
        <v-row>
                    ...
                    <template v-slot:default>
                        ...
                        <tbody>
                            <tr v-for="item in $store.getters.getCartItems" :key="item.id">
                                <td>
                                    <v-img style="height:80px; width:80px;" class="mt-2" :src="'/products/'+item.image">
                                ...
                                <td>{{item.price}}</td>
                                <td>
                                    <v-btn class="white--text" color="red" @click="() =>  removeItemFromCart(item)">X</v-btn>
                                </td>
                            </tr>
                        </tbody>
                    </template>
            ...
            <v-col :cols="12" md="3" sm="12" style="background-color:black;border-radius:7px;">
                ...
                <div class="text-center">
                    <v-btn class="white mt-5" outlined>
                        PROCEED TO PAY
                    </v-btn>
                </div>
            </v-col>
