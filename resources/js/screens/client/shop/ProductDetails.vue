            ...
            <v-container>
                ...
                <div class="row">
                    <div class="col-sm-12 col-xs-12 col-md-12">
                        ...
                        <v-card-text class="pa-0 pt-4" title outlined>
                            ...
                            <div class="row text-center">
                                <div class="col-md-2 col-sm-4 col-xs-12 text-center"
                                 v-for="productItem in products" :key="productItem.id">

                                    <v-hover v-slot:default="{hover}" open-delay="240">
                                        <v-card :elevation="hover? 16 : 2">
                                            <v-img :src="'/products/'+productItem.image" height="200px" class="white--text algin-end">
